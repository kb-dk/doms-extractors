...
mvn clean package
scp target/BroadcastExtractionService-*.war larm@iapetus:/home/larm/heb/bes/deploy_folder/war/bes_CSR.war
...
curl http://iapetus:9311/bes_CSR/rest/application.wadl | grep "resource path"
